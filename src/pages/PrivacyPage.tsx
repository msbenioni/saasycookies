  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-10">
      <GlassCard className="p-8 md:p-12">
        <h1 className="text-4xl font-heading font-bold mb-8 gradient-heading">Privacy Policy</h1>
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">2. Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">3. How We Use Your Information</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">4. Disclosure of Your Information</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">5. Data Storage and Security</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">6. Your Privacy Rights</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">7. Cookies and Tracking Technologies</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">8. Google Analytics</h2>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li><strong>Data Processing Agreement:</strong> We have entered into a data processing agreement with Google to ensure that they process your data in accordance with applicable privacy laws.</li>
            </ul>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">9. Children's Privacy</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">10. Changes to This Privacy Policy</h2>
            <p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last Updated" date at the top of this Privacy Policy.</p>
          </section>
          
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 heading-secondary">11. Contact Us</h2>
